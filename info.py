...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://AutoFilterXeonBot1:AutoFilterXeonBot1@cluster0.fuiwwpc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "AUTOFILTER") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'AUTOFILTER') # Collection name (default: dreamcinezone_files)
