...
├👨‍💻 Dᴇᴠᴇʟᴏᴘᴇʀ : <a href=https://t.me/MrXeonTg>xᴇᴏɴ</a>
├📕 Lɪʙʀᴀʀʏ : <a href=https://github.com/pyrogram>ᴘʏʀᴏɢʀᴀᴍ</a>
├✏️ Lᴀɴɢᴜᴀɢᴇ : <a href=https://www.python.org>ᴘʏᴛʜᴏɴ 3</a>
├💾 Dᴀᴛᴀʙᴀꜱᴇ : <a href=https://cloud.mongodb.com>ᴍᴏɴɢᴏ ᴅʙ</a>
├📡 H𝙾𝚂𝚃𝙴𝙳 : <a href=https://heroku.com>𝙷𝙴𝚁𝙾𝙺𝚄</a>
├📊 Bᴜɪʟᴅ ᴠᴇʀꜱɪᴏɴ : V5.2.1 [ ꜱᴛᴀʙʟᴇ ]
╰───────────────⍟</b>"""

    HELP_TXT = """» ᴡʜᴇʀᴇ ᴅᴏ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴏᴘᴇɴ ᴛʜᴇ sᴇᴛᴛɪɴɢs ᴍᴇɴᴜ?."""

    FEATURES_TXT = """ʜᴇʀᴇ ɪꜱ Features ᴍᴇɴᴜ"""
...
ᴏᴜʀ ᴍᴏᴠɪᴇ ᴀɴᴅ sᴇʀɪᴇs ɢʀᴏᴜᴘ <a href='https://t.me/XeonFlixGroup'>XEOɴFʟɪX ɢʀOUP</a>.</b>"""
    ...
    GTRANSLATE_TXT = """
<b>𝚃𝚑𝚒𝚜 𝚌𝚘𝚖𝚖𝚊𝚗𝚍 𝚑𝚎𝚕𝚙𝚜 𝚢𝚘𝚞 𝚝𝚘 𝚝𝚛𝚊𝚗𝚜𝚕𝚊𝚝𝚎 𝚊 𝚝𝚎𝚡𝚝 𝚝𝚘 𝖺𝗇𝗒 𝚕𝚊𝚗𝚐𝚞𝚊𝚐𝚎𝚜 𝚢𝚘𝚞 𝚠𝚊𝚗𝚝!

USAGE:
➢ /translate Hello world - 𝖳𝗈 𝗍𝗋𝖺𝗇𝗌𝗅𝖺𝗍𝖾𝗋 𝗍𝖾𝗑𝗍𝗌 𝗍𝗈 𝖺 𝗌𝗉𝖾𝖼𝗂𝖿𝖼 𝗅𝖺𝗇𝗀𝗎𝖺𝗀𝖾."""

    WEATHER_TXT = """
<b>Get information about weather!

USAGE:
➢ /weather [city name] - Get the information about the country."""

    CON_TXT = """
<b>Get information about country!

USAGE:
➢ /country [name] - Get the information about the country."""

    CORONA_TXT = """
<b>Get information about covid!

USAGE:
➢ /covid [name] - Get the information about the covid."""

    CREDIT_INFO = """
<b>⍟───[ ᴄʀᴇᴅɪᴛꜱ ]───⍟
    
➥ ᴏᴡɴᴇʀ : <a href='t.me/MrXeonTG'>ᴍʀ xᴇᴏɴ</a>​
➥ ғᴇᴀᴛᴜʀᴇꜱ ʙʏ : <a href='t.me/sewxiy'>sᴜʙᴀʀᴜ</a>
➥ ᴇᴅɪᴛᴇᴅ ʙʏ : <a href='t.me/Xeonflixadmin'>ɢᴏᴊᴏ ꜱᴀᴛᴏʀᴜ</a>
...
ᴛʜɪꜱ ɪꜱ ɴᴏᴛ ᴏᴘᴇɴ-sᴏᴜʀᴄᴇ ᴘʀᴏᴊᴇᴄᴛ. ʏᴏᴜ ᴄᴀɴ ᴜꜱᴇ ɪᴛ ꜰʀᴇᴇʟʏ, ʙᴜᴛ ʏᴏᴜ ᴄᴀɴ ᴘᴜʀᴄʜᴀꜱᴇ ᴛʜɪꜱ ʀᴇᴘᴏ sᴏ ᴄᴏɴᴛᴀᴄᴛ\n
